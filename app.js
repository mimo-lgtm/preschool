// 1. 設定項目（あなたのGASウェブアプリURLに置き換えてください）
                    ...
                    <div class="list-group list-group-flush">
                        ${filtered.map(o => `
                            <div class="list-group-item px-0 py-2">
                                ...
                                ${o.mergeReason ? `<div class="alert alert-light border py-1 px-2 mt-1 mb-0" style="font-size:0.82em;">配置理由: ${o.mergeReason}</div>` : ''}
                            </div>
                        `).join('')}
